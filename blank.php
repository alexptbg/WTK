		    ...
		    <ul id="side-nav" class="main-menu navbar-collapse collapse">
			    ...
			    <li class="has-sub active"><a href="javascript:void(0);"><i class="icon-cog"></i><span class="title">Settings</span></a>
				    <ul class="nav collapse">
					    ...
					    <li><a href="#.php"><span class="title">Users</span></a></li>
				    </ul>
			    </li>
	        ...
	        <div class="main-content">
				    ...
				    <div class="col-lg-12">
					    <div class="panel panel-primary">
						    <div class="panel-heading clearfix">
							    <h4 class="panel-title text-uppercase">Clocks configured</h4>
							    <ul class="panel-tool-options">
									<?php if ($user_settings['level'] >= 50): ?>
									<li data-toggle="tooltip" data-placement="bottom" title="ADD A NEW CLOCK TO DB">
										<a id="add" href="modals/clocks_add.php" data-remote="true" data-toggle="modal" data-target="#modal-2" tag="ADD A NEW CLOCK TO DB"><i class="icon-plus"></i></a>
									</li>
									<li data-toggle="tooltip" data-placement="bottom" title="REBOOT ALL CLOCKS">
										<a id="rebull" href="modals/clocks_reboot_all.php?reboot=all" data-remote="true" data-toggle="modal" data-target="#modal-2" tag="REBOOT ALL CLOCKS"><i class="icon-retweet"></i></a>
									</li>
                                        ...
                                        foreach($devices as $clock) {
										    ...
										    <tr class=\"gradeX\">
											    ...
											    if ($user_settings['level'] >= 50) {
												    echo "
											    <td>
											    	<a id=\"edit\" href=\"modals/clocks_edit.php?serialnumber=".$clock['serialnumber']."\" data-remote=\"true\" data-toggle=\"modal\" data-target=\"#modal-2\" tag=\"EDIT CLOCK ".$clock['inv']."\" class=\"btn btn-warning btn-sm\"><i class=\"fa fa-edit\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"EDIT CLOCK ".$clock['inv']."\"></i></a>

											    	<a id=\"synch\" href=\"modals/clocks_config.php?serialnumber=".$clock['serialnumber']."\" data-remote=\"true\" data-toggle=\"modal\" data-target=\"#modal-2\" tag=\"REMOTE CONFIGURE CLOCK ".$clock['inv']."\" class=\"btn btn-info btn-sm\"><i class=\"fa fa-cog\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"REMOTE CONFIGURE CLOCK ".$clock['inv']."\"></i></a>
											    	
											    	<a id=\"remove\" href=\"modals/clocks_remove.php?serialnumber=".$clock['serialnumber']."\" data-remote=\"true\" data-toggle=\"modal\" data-target=\"#modal-2\" tag=\"REMOVE CLOCK ".$clock['inv']." FROM DATABASE\" class=\"btn btn-danger btn-sm\"><i class=\"fa fa-trash\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"REMOVE CLOCK ".$clock['inv']." FROM DATABASE\"></i></a>
											    	
											    	<a id=\"reboot\" href=\"modals/clocks_reboot.php?serialnumber=".$clock['serialnumber']."\" data-remote=\"true\" data-toggle=\"modal\" data-target=\"#modal-2\" tag=\"REBOOT CLOCK ".$clock['inv']."\" class=\"btn btn-danger btn-sm\"><i class=\"fa fa-retweet\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"REBOOT CLOCK ".$clock['inv']."\"></i></a>
											    </td>";
												...
												<td>
											    	...
											    	<button data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"REMOTE CONFIGURE CLOCK ".$clock['inv']."\" class=\"btn btn-info btn-sm\" disabled=\"disabled\"><i class=\"fa fa-cog\"></i></a>
											    	...
											    	<button data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"REBOOT CLOCK ".$clock['inv']."\" class=\"btn btn-danger btn-sm\" disabled=\"disabled\"><i class=\"fa fa-retweet\"></i></a>
											    </td>";
												} else {
													echo "
											    <td>
		        ...
		        <div class="row">
			        <div class="col-lg-12">
					    <div class="panel panel-primary">
						    <div class="panel-heading clearfix">
							    <h4 class="panel-title text-uppercase">Status</h4>
							    <ul class="panel-tool-options"> 
