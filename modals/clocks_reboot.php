...
<form id="forms" class="form-horizontal" method="post">
	...
	<div class="form-group"> 
		...
		<div class="col-sm-9"> 
			<input type="text" class="form-control validate[required]" name="ip" id="ip" value="<?php echo $device['ip']; ?>" readonly="readonly" /> 
		</div> 
	</div>
	<div class="form-group"> 
	...
	<div class="form-group">
	    <div class="col-sm-12">
			<div class="fr">
			    ...
			    <button type="submit" class="btn btn-danger" name="submit" id="submit"><i class="fa fa-trash" aria-hidden="true"></i>&nbsp;REBOOT</button>
			</div>
		</div>
	</div>
</form>
...
<script type="text/javascript">
    ...
    jQuery("#forms").on('click', '#submit', function(e) {
      ...
      if (valid == true) {
        ...
        var datastr = 'id='+id+'&inv='+inv+'&ip='+ip+'&confirm='+confirm;
        //console.log(datastr);
        send(datastr);
      } else {
      	e.preventDefault();
